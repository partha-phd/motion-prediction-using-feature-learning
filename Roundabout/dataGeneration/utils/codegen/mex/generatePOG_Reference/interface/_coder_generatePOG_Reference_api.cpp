...
static const mxArray *emlrt_marshallOut(const real_T u[25200]);
...
{
  emlrtMsgIdentifier thisId;
  static const char * fieldNames[4] = { "xPos", "yPos", "bboxX", "bboxY" };
  ...
  thisId.bParentIsCell = false;
  emlrtCheckVsStructR2012b(sp, parentId, u, 4, fieldNames, 2U, dims, &bv[0],
    sizes);
  i = y->size[0] * y->size[1];
  y->size[0] = sizes[0];
  y->size[1] = sizes[1];
  ...
  for (i = 0; i < sizes[1]; i++) {
    thisId.fIdentifier = "xPos";
    e_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, i, 0, "xPos")),
                       &thisId, y->data[i].xPos);
    thisId.fIdentifier = "yPos";
    e_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, i, 1, "yPos")),
                       &thisId, y->data[i].yPos);
    thisId.fIdentifier = "bboxX";
    f_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, i, 2, "bboxX")),
                       &thisId, y->data[i].bboxX);
    thisId.fIdentifier = "bboxY";
    f_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, i, 3, "bboxY")),
...
static const mxArray *emlrt_marshallOut(const real_T u[25200])
{
  ...
  static const int32_T iv1[2] = { 140, 180 };
...
void generatePOG_Reference_api(generatePOG_ReferenceStackData *SD, const mxArray
  * const prhs[4], int32_T, const mxArray *plhs[1])
{
  real_T (*POG)[25200];
  ...
  POG = (real_T (*)[25200])mxMalloc(sizeof(real_T [25200]));
  ...
  generatePOG_Reference(SD, &st, x_Road, y_Road, vehicle, n, *POG);
