    ...
    methods
        ...
        function drive(obj,xInitial,yInitial,psiInitial,vInitial,...
            ...
            elseif obj.speed(currentStep-1) < 50/3.6
                anticipationTime=(0.5-1)/(50-10)*...
                    obj.speed(currentStep-1)*3.6+1-(0.5-1)/(50-10)*10;
            else
            ...
            %% Stability analysis
            if (abs(obj.beta(currentStep)) > 1)
                obj.stability = false;
            elseif (sqrt(obj.longitudinalAccn(currentStep)^2+...
                    obj.lateralAccn(currentStep)^2)>= 10)
                obj.stability = false;
            end
