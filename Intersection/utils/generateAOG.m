...
augmentedOccupancyGrid(:,:,1) = rot90(reshape(occupancyGrid(1:5:80000),...
    [160 100]));
augmentedOccupancyGrid(:,:,2) = rot90(reshape(occupancyGrid(2:5:80000),...
    [160 100]));
augmentedOccupancyGrid(:,:,3) = rot90(reshape(occupancyGrid(3:5:80000),...
    [160 100]));
augmentedOccupancyGrid(:,:,4) = rot90(reshape(occupancyGrid(4:5:80000),...
    [160 100]));
augmentedOccupancyGrid(:,:,5) = rot90(reshape(occupancyGrid(5:5:80000),...
    [160 100]));
end
