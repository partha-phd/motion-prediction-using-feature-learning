...
static emlrtRSInfo k_emlrtRSI = { 233, /* lineNo */
  "countLoops",                        /* fcnName */
  "C:\\Program Files\\MATLAB\\R2019b\\toolbox\\eml\\lib\\matlab\\polyfun\\inpolygon.m"/* pathName */
};

static emlrtRSInfo l_emlrtRSI = { 238, /* lineNo */
  "countLoops",                        /* fcnName */
  "C:\\Program Files\\MATLAB\\R2019b\\toolbox\\eml\\lib\\matlab\\polyfun\\inpolygon.m"/* pathName */
};

static emlrtRSInfo m_emlrtRSI = { 250, /* lineNo */
  "countLoops",                        /* fcnName */
  "C:\\Program Files\\MATLAB\\R2019b\\toolbox\\eml\\lib\\matlab\\polyfun\\inpolygon.m"/* pathName */
};

static emlrtRSInfo n_emlrtRSI = { 329, /* lineNo */
  "computeRange",                      /* fcnName */
  "C:\\Program Files\\MATLAB\\R2019b\\toolbox\\eml\\lib\\matlab\\polyfun\\inpolygon.m"/* pathName */
};

static emlrtRSInfo o_emlrtRSI = { 330, /* lineNo */
  "computeRange",                      /* fcnName */
  "C:\\Program Files\\MATLAB\\R2019b\\toolbox\\eml\\lib\\matlab\\polyfun\\inpolygon.m"/* pathName */
};

static emlrtRSInfo q_emlrtRSI = { 316, /* lineNo */
  "checkRange",                        /* fcnName */
  "C:\\Program Files\\MATLAB\\R2019b\\toolbox\\eml\\lib\\matlab\\polyfun\\inpolygon.m"/* pathName */
};

static emlrtRSInfo r_emlrtRSI = { 319, /* lineNo */
  "checkRange",                        /* fcnName */
  "C:\\Program Files\\MATLAB\\R2019b\\toolbox\\eml\\lib\\matlab\\polyfun\\inpolygon.m"/* pathName */
};
...
static emlrtRSInfo t_emlrtRSI = { 193, /* lineNo */
  "computeScaleFactors",               /* fcnName */
  "C:\\Program Files\\MATLAB\\R2019b\\toolbox\\eml\\lib\\matlab\\polyfun\\inpolygon.m"/* pathName */
};
...
static emlrtRSInfo v_emlrtRSI = { 99,  /* lineNo */
  "scalarInpolygon",                   /* fcnName */
  "C:\\Program Files\\MATLAB\\R2019b\\toolbox\\eml\\lib\\matlab\\polyfun\\inpolygon.m"/* pathName */
};
...
static emlrtRTEInfo c_emlrtRTEI = { 262,/* lineNo */
  27,                                  /* colNo */
  "skipNaNs",                          /* fName */
  "C:\\Program Files\\MATLAB\\R2019b\\toolbox\\eml\\lib\\matlab\\polyfun\\inpolygon.m"/* pName */
};
...
static void countLoops(const emlrtStack *sp, const real_T xv[5], const real_T
  yv[5], int32_T *nloops, int32_T first[5], int32_T last[5]);
  ...
  yv[5], int32_T *nloops, int32_T first[5], int32_T last[5])
{
  ...
  *nloops = 0;
  ...
  exitg1 = false;
  while ((!exitg1) && (i + 1 <= 5)) {
    isnanxv = muDoubleScalarIsNaN(xv[i]);
    if (isnanxv != muDoubleScalarIsNaN(yv[i])) {
  ...
  while (i + 1 <= 5) {
    ...
    while ((!exitg1) && (i + 1 < 5)) {
      i++;
      isnanxv = muDoubleScalarIsNaN(xv[i]);
      isnanyv = muDoubleScalarIsNaN(yv[i]);
      if (isnanxv || isnanyv) {
        if (isnanxv != isnanyv) {
                 ...
                 const real_T xv[5], const real_T yv[5], boolean_T in[5])
{
  ...
  st.site = &d_emlrtRSI;
  countLoops(&st, xv, yv, &nloops, first, last);
  if (nloops != 0) {
    st.site = &e_emlrtRSI;
    ...
    for (j = 0; j < 5; j++) {
      st.site = &y_emlrtRSI;
      in[j] = scalarInpolygon(&st, x[j], y[j], xv, yv, nloops, first, last,
