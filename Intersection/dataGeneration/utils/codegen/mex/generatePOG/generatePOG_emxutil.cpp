...
static void emxFreeStruct_struct0_T(struct0_T *pStruct)
{
  emxFree_real_T(&pStruct->xCoordinates);
  emxFree_real_T(&pStruct->yCoordinates);
  emxFree_real_T(&pStruct->minProb);
}

static void emxInitStruct_struct0_T(const emlrtStack *sp, struct0_T *pStruct,
  const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxInit_real_T(sp, &pStruct->xCoordinates, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->yCoordinates, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->minProb, 2, srcLocation, doPush);
}
...
/* End of code generation (generatePOG_emxutil.cpp) */
