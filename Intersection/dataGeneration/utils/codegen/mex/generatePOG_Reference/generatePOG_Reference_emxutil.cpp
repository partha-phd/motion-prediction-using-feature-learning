...
static void emxFreeStruct_struct0_T(struct0_T *pStruct)
{
  ...
  emxFree_real_T(&pStruct->posX);
  emxFree_real_T(&pStruct->posY);
  emxFree_real_T(&pStruct->psi);
  emxFree_real_T(&pStruct->v);
  emxFree_real_T(&pStruct->aX);
  emxFree_real_T(&pStruct->aY);
  ...
  const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  ...
  emxInit_real_T(sp, &pStruct->posX, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->posY, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->psi, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->v, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->aX, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->aY, 2, srcLocation, doPush);
